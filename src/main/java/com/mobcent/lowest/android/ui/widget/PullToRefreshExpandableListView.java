...
public class PullToRefreshExpandableListView extends ExpandableListView implements android.widget.AbsListView.OnScrollListener {
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            if (this.startTime == -1) {
                ...
                PullToRefreshExpandableListView.this.headerLayout.setPadding(0, this.currentY, 0, 0);
                PullToRefreshExpandableListView.this.springBack = this.currentY;
            }
    ...
    class clickToRefresh implements OnClickListener {
        ...
        public void onClick(View v) {
            if (PullToRefreshExpandableListView.this.bottomState != 3 && PullToRefreshExpandableListView.this.bottomState != 5) {
                PullToRefreshExpandableListView.this.bottomState = 1;
                PullToRefreshExpandableListView.this.footerLayout.bottomRefreshing();
                PullToRefreshExpandableListView.this.onBottomRefresh();
            } else if (PullToRefreshExpandableListView.this.bottomState == 5) {
                PullToRefreshExpandableListView.this.setSelection(0);
                PullToRefreshExpandableListView.this.handler.postDelayed(new Runnable() {
                    public void run() {
                        PullToRefreshExpandableListView.this.onHandRefresh();
                    }
                }, 300);
            }
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.refreshingLabel = this.mcResource.getString("mc_forum_posts_loading_head");
        ...
        this.refreshingLabelbottom = this.mcResource.getString("mc_forum_posts_loading_head");
    ...
    private void measureView(View child) {
        int childHeightSpec;
        LayoutParams p = (AbsListView.LayoutParams)child.getLayoutParams();
        if (p == null) {
    ...
    public void editHeaderLabelColor(int color) {
