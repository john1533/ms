...
public class MCShareProgressBar extends ImageView {
    ...
    public MCShareProgressBar(Context context, boolean isCreate) {
        super(context);
        init();
        this.width = (int) getResources().getDimension(this.resource.getDimenId("mc_forum_share_progress_bar_width"));
        this.height = (int) getResources().getDimension(this.resource.getDimenId("mc_forum_share_progress_bar_height"));
    }
