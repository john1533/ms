...
//            }
    ...
    private static void dealPlazaBundle(Bundle bundle, ConfigComponentModel componentModel, Fragment fragment) {
        ...
        bundle.putSerializable(PlazaConstant.INTENT_PLAZA_MODEL, intentModel);
    }
}
