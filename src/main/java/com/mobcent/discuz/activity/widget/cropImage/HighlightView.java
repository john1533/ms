...
public class HighlightView {
    ...
    private void init() {
        ...
        MCResource mcResource = MCResource.getInstance(this.mContext.getContext());
        this.mResizeDrawableWidth = resources.getDrawable(mcResource.getDrawableId("mc_forum_camera_picture_crop_dot"));
        this.mResizeDrawableHeight = resources.getDrawable(mcResource.getDrawableId("mc_forum_camera_picture_crop_dot"));
        this.mResizeDrawableDiagonal = resources.getDrawable(mcResource.getDrawableId("mc_forum_camera_picture_crop_dot"));
    }
