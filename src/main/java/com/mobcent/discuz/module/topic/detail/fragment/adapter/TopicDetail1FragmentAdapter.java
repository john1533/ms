...
public class TopicDetail1FragmentAdapter extends TopicDetailGroupAdapter {
    ...
    public TopicDetail1FragmentAdapter(Context context, List<Object> detailList, String TAG) {
    ...
    public void updatePostsLastView(BasePostsLastHolder holder, PostsModel postsModel) {
        ...
        holder.getShareToMoments().setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                TopicDetail1FragmentAdapter.this.share(2);
            }
        });
        holder.getShareToWeChat().setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                TopicDetail1FragmentAdapter.this.share(1);
            }
        });
        MCTouchUtil.createTouchDelegate(holder.getPraiseBtn(), 10);
        MCTouchUtil.createTouchDelegate(holder.getMoreBtn(), 10);
                ...
                holder.getTextView().setOnLongClickListener(new OnLongClickListener() {
                    public boolean onLongClick(View v) {
                        if (TopicDetail1FragmentAdapter.this.longClickDialog == null) {
                            ...
                            TopicDetail1FragmentAdapter.this.longClickDialog = new Builder(TopicDetail1FragmentAdapter.this.context).setItems(TopicDetail1FragmentAdapter.this.items, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (TopicDetail1FragmentAdapter.this.resource.getString("mc_forum_copy_content").equals(TopicDetail1FragmentAdapter.this.items[which])) {
                                        ((ClipboardManager) TopicDetail1FragmentAdapter.this.context.getSystemService("clipboard")).setText(topicContentModel.getInfor());
                                        MCToastUtils.toastByResName(TopicDetail1FragmentAdapter.this.context.getApplicationContext(), "mc_forum_tel_copy_to_clipboard");
                                    }
                                }
                            }).create();
            ...
            case 1:
                ...
                holder.getImgView().setOnClickListener(new OnClickListener() {
                    public void onClick(View arg0) {
                        ...
                        if (z) {
                            tempRichList = TopicDetail1FragmentAdapter.this.topicRichList;
                        } else {
                            tempRichList = TopicDetail1FragmentAdapter.this.replyRichList;
                        }
                        ImagePreviewHelper.getInstance().startImagePreview((Activity) TopicDetail1FragmentAdapter.this.context, tempRichList, MCAsyncTaskLoaderImage.formatUrl(topicContentModel2.getOriginalInfo(), FinalConstant.RESOLUTION_BIG), new ImageViewerListener() {
                            public void sharePic(Context context, RichImageModel imgModel, String localPath) {
                                ...
                                shareModel.setDownloadUrl(TopicDetail1FragmentAdapter.this.resource.getString("mc_share_download_url"));
                ...
                holder.getVideoView().setOnClickListener(new OnClickListener() {
                    public void onClick(View arg0) {
                        if (!MCStringUtil.isEmpty(topicContentModel.getInfor())) {
                            Intent intent = new Intent(TopicDetail1FragmentAdapter.this.context, WebViewFragmentActivity.class);
